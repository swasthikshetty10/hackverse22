  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center">
        <img
          alt="Placeholder"
          className="mb-2 text-center block rounded-full"
          src="https://cdn-icons-png.flaticon.com/512/3462/3462067.png"
          width="32"
          height="32"
        />
        <h4 className="ml-2 text-center text-2xl font-normal leading-normal mt-0 mb-2 text-gray-800">
          Estimated Budget
        </h4>
      </div>
      {/* Cost Table */}
